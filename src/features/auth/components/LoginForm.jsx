  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit} noValidate>
      ...
      <div className={styles.field}>
        <label className={labelClass('email')}>Adresse email</label>
        <input
          name="email"
          type="email"
          value={form.email}
      ...
      {/* Password */}
      <div className={styles.field}>
        <label className={labelClass('password')}>Mot de passe</label>
        <input
          name="password"
      ...
      {error && (
        <div className={styles.apiError}>
          ...
          <p className={styles.apiErrorText}>{error}</p>
        </div>
      )}
      ...
      <div className={styles.divider}>
        ...
        <span className={styles.dividerText}>Ou continuez avec</span>
        <span className={styles.dividerLine} />
      </div>
      ...
      <p className={styles.demoHint}>
        Espace demo : <strong>admin@depensys.com</strong> / <strong>password</strong>
      </p>
    </form>
  );
}
